...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        # Compute size after 2x2 max pooling ( dividing height and width by 2)
        pool_out_dim = (H // 2) * (W // 2) * num_filters

        # Hidden affine layer weights and biases
        self.params['W2'] = np.random.randn(pool_out_dim, hidden_dim) * weight_scale
